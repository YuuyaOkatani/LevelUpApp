    ...
    const ImprovedSelectList: React.FC<SelectListProps> = ({
        ...
        const renderOption = useCallback(
            (item: any, index: number) => (
                ...
                >
                    <Text style={[styles.dropdownText, dropdownTextStyles, { fontFamily, color: 'white', fontSize: 20 }]}>
            ...
            <View style={styles.container}>
                {
                    (isDropdownVisible && search)
                        ...
                        <View style={[styles.wrapper, { ...appStyles.textStyle, ...boxStyles }]}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                                ...
                                <TextInput
                                    ...
                                    style={[{ padding: 0, height: 20, flex: 1, fontFamily, color: 'white', fontSize: 20 }, inputStyles]}
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.8}
                        >
                            <Text style={[appStyles.textStyle, { fontSize: 20, width: 'auto', ...inputStyles }]}>
                ...
                <Animated.View style={[styles.dropdownContainer, { maxHeight: dropdownHeight, ...dropdownStyles }]}>
                    {isDropdownVisible && (
                        <ScrollView keyboardShouldPersistTaps='handled'>
                            {filteredOptions.length > 0 ? (
                                filteredOptions.map(renderOption)
                            ) : (
                                <Text style={[styles.notFoundText, appStyles.textStyle]}>{notFoundText}</Text>
                            )}
                        </ScrollView>
                    )}
                </Animated.View>
